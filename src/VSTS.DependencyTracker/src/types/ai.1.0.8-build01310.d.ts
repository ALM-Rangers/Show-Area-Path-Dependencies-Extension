declare module Microsoft.ApplicationInsights {
    ...
    enum _InternalMessageId {
        ...
        NONUSRACT_FailedToFixDepricatedValues = 43,
        NONUSRACT_InvalidDurationValue = 44,
        USRACT_CannotSerializeObject = 45,
        USRACT_CannotSerializeObjectNonSerializable = 46,
        USRACT_CircularReferenceDetected = 47,
        USRACT_ClearAuthContextFailed = 48,
        USRACT_ExceptionTruncated = 49,
        USRACT_IllegalCharsInName = 50,
        USRACT_ItemNotInArray = 51,
        USRACT_MaxAjaxPerPVExceeded = 52,
        USRACT_MessageTruncated = 53,
        USRACT_NameTooLong = 54,
        USRACT_SampleRateOutOfRange = 55,
        USRACT_SetAuthContextFailed = 56,
        USRACT_SetAuthContextFailedAccountName = 57,
        USRACT_StringValueTooLong = 58,
        USRACT_StartCalledMoreThanOnce = 59,
        USRACT_StopCalledWithoutStart = 60,
        USRACT_TelemetryInitializerFailed = 61,
        USRACT_TrackArgumentsNotSpecified = 62,
        USRACT_UrlTooLong = 63,
        USRACT_SessionStorageBufferFull = 64,
        USRACT_CannotAccessCookie = 65,
    }
