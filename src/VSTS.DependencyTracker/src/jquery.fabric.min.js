...
fabric.Breadcrumb = function (e) { this.breadcrumb = e, this.breadcrumbList = e.querySelector(".ms-Breadcrumb-list"), this.listItems = e.querySelectorAll(".ms-Breadcrumb-listItem"), this.contextMenu = e.querySelector(".ms-ContextualMenu"), this.overflowButton = e.querySelector(".ms-Breadcrumb-overflowButton"), this.overflowMenu = e.querySelector(".ms-Breadcrumb-overflowMenu"), this.itemCollection = [], this.currentMaxItems = 0, this.init(); }, fabric.Breadcrumb.prototype = function () { var e = 639, t = function () { p.call(this), a.call(this), o.call(this, null); }, i = function (e, t, i) { this.itemCollection.push({ text: e, link: t, tabIndex: i }), g.call(this); }, n = function (e) { for (var t = this.itemCollection.length; t--;)
    ...
    for (l = 0; o > l; l += 1)
        if (n.isDateOverlap(s[l], e)) {
            s[l] = null;
            break;
        } i && s.push(i); }), s.filter(function (e) { return null != e; }); }, i.prototype.nodes = function (e) { var t = this, i = t.settings, o = t.item, r = o.now, l = o.select, c = o.highlight, d = o.view, m = o.disable, u = o.min, h = o.max, f = function (e, t) { return i.firstDay && (e.push(e.shift()), t.push(t.shift())), a.node("thead", a.node("tr", a.group({ min: 0, max: n - 1, i: 1, node: "th", item: function (n) { return [e[n], i.klass.weekdays, 'scope=col title="' + t[n] + '"']; } }))); }((i.showWeekdaysFull ? i.weekdaysFull : i.weekdaysShort).slice(0), i.weekdaysFull.slice(0)), p = function (e) { return a.node("div", " ", i.klass["nav" + (e ? "Next" : "Prev")] + (e && d.year >= h.year && d.month >= h.month || !e && d.year <= u.year && d.month <= u.month ? " " + i.klass.navDisabled : ""), "data-nav=" + (e || -1) + " " + a.ariaAttr({ role: "button", components: t.$node[0].id + "_table" }) + ' title="' + (e ? i.labelMonthNext : i.labelMonthPrev) + '"'); }, v = function () { var n = i.showMonthsShort ? i.monthsShort : i.monthsFull; return i.selectMonths ? a.node("select", a.group({ min: 0, max: 11, i: 1, node: "option", item: function (e) { return [n[e], 0, "value=" + e + (d.month == e ? " selected" : "") + (d.year == u.year && e < u.month || d.year == h.year && e > h.month ? " disabled" : "")]; } }), i.klass.selectMonth, (e ? "" : "disabled") + " " + a.ariaAttr({ components: t.$node[0].id + "_table" }) + ' title="' + i.labelMonthSelect + '"') : a.node("div", n[d.month], i.klass.month); }, g = function () { var n = d.year, s = i.selectYears === !0 ? 5 : ~~(i.selectYears / 2); if (s) {
    var o = u.year, r = h.year, l = n - s, c = n + s;
    if (o > l && (c += o - l, l = o), c > r) {
        var m = l - o, f = c - r;
        l -= m > f ? f : m, c = r;
    }
    return a.node("select", a.group({ min: l, max: c, i: 1, node: "option", item: function (e) { return [e, 0, "value=" + e + (n == e ? " selected" : "")]; } }), i.klass.selectYear, (e ? "" : "disabled") + " " + a.ariaAttr({ components: t.$node[0].id + "_table" }) + ' title="' + i.labelYearSelect + '"');
} return a.node("div", n, i.klass.year); }; return a.node("div", (i.selectYears ? g() + v() : v() + g()) + p() + p(1), i.klass.header) + a.node("table", f + a.node("tbody", a.group({ min: 0, max: s - 1, i: 1, node: "tr", item: function (e) { var s = i.firstDay && 0 === t.create([d.year, d.month, 1]).day ? -7 : 0; return [a.group({ min: n * e - d.day + s + 1, max: function () { return this.min + n - 1; }, i: 1, node: "td", item: function (e) { e = t.create([d.year, d.month, e + (i.firstDay ? 1 : 0)]); var n = l && l.pick == e.pick, s = c && c.pick == e.pick, o = m && t.disabled(e) || e.pick < u.pick || e.pick > h.pick; return [a.node("div", e.date, function (t) { return t.push(d.month == e.month ? i.klass.infocus : i.klass.outfocus), r.pick == e.pick && t.push(i.klass.now), n && t.push(i.klass.selected), s && t.push(i.klass.highlighted), o && t.push(i.klass.disabled), t.join(" "); }([i.klass.day]), "data-pick=" + e.pick + " " + a.ariaAttr({ role: "gridcell", selected: !(!n || t.$node.val() !== a.trigger(t.formats.toString, t, [i.format, e])) || null, activedescendant: !!s || null, disabled: !!o || null })), "", a.ariaAttr({ role: "presentation" })]; } })]; } })), i.klass.table, 'id="' + t.$node[0].id + '_table" ' + a.ariaAttr({ role: "grid", components: t.$node[0].id, readonly: !0 })) + a.node("div", a.node("button", i.today, i.klass.buttonToday, "type=button data-pick=" + r.pick + (e && !t.disabled(r) ? "" : " disabled") + " " + a.ariaAttr({ components: t.$node[0].id })) + a.node("button", i.clear, i.klass.buttonClear, "type=button data-clear=1" + (e ? "" : " disabled") + " " + a.ariaAttr({ components: t.$node[0].id })) + a.node("button", i.close, i.klass.buttonClose, "type=button data-close=true " + (e ? "" : " disabled") + " " + a.ariaAttr({ components: t.$node[0].id })), i.klass.footer); }, i.defaults = function (e) { return { labelMonthNext: "Next month", labelMonthPrev: "Previous month", labelMonthSelect: "Select a month", labelYearSelect: "Select a year", monthsFull: ["January", "February", "March", "April", "May", "June", "July", "August", "September", "October", "November", "December"], monthsShort: ["Jan", "Feb", "Mar", "Apr", "May", "Jun", "Jul", "Aug", "Sep", "Oct", "Nov", "Dec"], weekdaysFull: ["Sunday", "Monday", "Tuesday", "Wednesday", "Thursday", "Friday", "Saturday"], weekdaysShort: ["Sun", "Mon", "Tue", "Wed", "Thu", "Fri", "Sat"], today: "Today", clear: "Clear", close: "Close", format: "d mmmm, yyyy", klass: { table: e + "table", header: e + "header", navPrev: e + "nav--prev", navNext: e + "nav--next", navDisabled: e + "nav--disabled", month: e + "month", year: e + "year", selectMonth: e + "select--month", selectYear: e + "select--year", weekdays: e + "weekday", day: e + "day", disabled: e + "day--disabled", selected: e + "day--selected", highlighted: e + "day--highlighted", now: e + "day--today", infocus: e + "day--infocus", outfocus: e + "day--outfocus", footer: e + "footer", buttonClear: e + "button--clear", buttonToday: e + "button--today", buttonClose: e + "button--close" } }; }(e.klasses().picker + "__"), e.extend("pickadate", i); }), function (e) { e.fn.Dialog = function () { return e(".js-DialogAction--open").each(function () { e(this).on("click", function () { var t = e(this).data("target"); e(t).show(); }); }), this.each(function () { var t = this; e(t).hide(), e(t).find(".js-DialogAction--close").each(function () { e(this).on("click", function () { e(t).hide(); }); }), e(t).find(".ms-Dialog-action").on("click", function () { e(t).hide(); }); }); }; }(jQuery), function (e) {
    e.fn.Dropdown = function () {
        return this.each(function () {
            function t(t) { if (!i.hasClass("is-disabled")) {
                i.find(".is-open").removeClass("is-open"), t.stopPropagation();
                var n = e(this).parents(".ms-Dropdown").width();
                e(this).next(".ms-Dropdown-items").css("width", n + "px"), i.toggleClass("is-open"), e(".ms-Dropdown").each(function () { e(this)[0] !== i[0] && e(this).removeClass("is-open"); }), e(document).bind("click.dropdown", function () { i.removeClass("is-open"), e(document).unbind("click.dropdown"); });
            } }
            var i = e(this), n = i.children(".ms-Dropdown-select"), s = n.children("option"), a = "", o = "", r = "";
            s.each(function (e, t) { t.selected && (a = t.text), o += '<li class="ms-Dropdown-item' + (t.disabled ? ' is-disabled"' : '"') + ">" + t.text + "</li>"; }), r = '<span class="ms-Dropdown-title">' + a + '</span><ul class="ms-Dropdown-items">' + o + "</ul>", i.append(r), i.on("click", ".ms-Dropdown-title", function (e) { t(e); }), i.on("keyup", function (s) {
                var a = s.keyCode || s.which;
                if (e(this).hasClass("is-open")) {
                    if (e(this).hasClass("is-open") && (38 === a && e(this).find(".ms-Dropdown-item.is-selected").prev().siblings().size() > 0 && e(this).find(".ms-Dropdown-item.is-selected").removeClass("is-selected").prev().addClass("is-selected"),
                        40 === a && e(this).find(".ms-Dropdown-item.is-selected").next().siblings().size() > 0 && e(this).find(".ms-Dropdown-item.is-selected").removeClass("is-selected").next().addClass("is-selected"), 13 === a && !i.hasClass("is-disabled"))) {
                        var o = e(this).find(".ms-Dropdown-item.is-selected").text();
                        e(this).find(".ms-Dropdown-title").html(o), n.find("option").each(function (t, i) { i.text === o ? e(this).prop("selected", !0) : e(this).prop("selected", !1); }), n.change(), e(this).removeClass("is-open");
                    }
                }
                else
                    13 !== a && 38 !== a && 40 !== a || (t(s), e(this).find(".ms-Dropdown-item").hasClass("is-selected") || e(this).find(".ms-Dropdown-item:first").addClass("is-selected"));
                27 === a && e(this).removeClass("is-open");
            }), i.on("click", ".ms-Dropdown-item", function () { if (!i.hasClass("is-disabled") && !e(this).hasClass("is-disabled")) {
                e(this).siblings(".ms-Dropdown-item").removeClass("is-selected"), e(this).addClass("is-selected"), e(this).parents().siblings(".ms-Dropdown-title").html(e(this).text());
                var t = e(this).text();
                n.find("option").each(function (i, n) { n.text === t ? e(this).prop("selected", !0) : e(this).prop("selected", !1); }), n.change();
            } });
        });
    };
}(jQuery), function (e) { e.fn.Facepile = function () { return this.each(function () { e(".ms-PeoplePicker").PeoplePicker(), e(".ms-Panel").Panel(); var t = e(this), i = e(".ms-Facepile-members"), n = e(".ms-Facepile-members > .ms-Facepile-itemBtn").length, s = e(".ms-Facepile-panel.ms-Panel"), a = s.find(".ms-Panel-main"), o = e(".ms-PeoplePicker.ms-PeoplePicker--Facepile"), r = o.find(".ms-PeoplePicker-selectedPeople"), l = e(".ms-Facepile").find(".ms-PersonaCard"), c = function () { if (n += 1, e(".ms-Facepile-members").children(":gt(4)").hide(), n > 5) {
    e(".ms-Facepile-itemBtn--overflow").addClass("is-active");
    var t = n - 5;
    e(".ms-Facepile-overflowText").text("+" + t);
} }; t.on("click", ".js-addPerson", function () { a.css({ display: "block" }), s.toggleClass("is-open").addClass("ms-Panel-animateIn").removeClass("ms-Facepile-panel--overflow ms-Panel--right").addClass("ms-Facepile-panel--addPerson"), l.removeClass("is-active").hide(); }), s.on("click", ".js-togglePanel", function () { s.toggleClass("is-open").addClass("ms-Panel-animateIn"); }), t.on("click", ".js-overflowPanel", function () { a.css({ display: "block" }), s.toggleClass("is-open").addClass("ms-Panel-animateIn").removeClass("ms-Facepile-panel--addPerson").addClass("ms-Facepile-panel--overflow ms-Panel--right"); }), e(document).ready(function () { e(".ms-Facepile-overflowText").text("+" + n); }), e(".ms-PeoplePicker-result").on("click", function () { var t = e(this), n = t.find(".ms-Persona-primaryText").html(), s = t.find(".ms-Persona-secondaryText").html(), a = function () { for (var e = n.split(" "), t = "", i = 0; i < e.length; i++)
    t += e[i].charAt(0); return t.substring(0, 2); }(), o = t.find(".ms-Persona-initials").attr("class"), r = function () { if (t.find(".ms-Persona-image").length) {
    var e = t.find(".ms-Persona-image").attr("src");
    return '<img class="ms-Persona-image" src="' + e + '" alt="Persona image">';
} return ""; }(), l = '<button class="ms-Facepile-itemBtn ms-Facepile-itemBtn--member" title="' + n + '"><div class="ms-Persona ms-Persona--xs"><div class="ms-Persona-imageArea"><div class="' + o + '">' + a + "</div>" + r + '</div><div class="ms-Persona-presence"></div><div class="ms-Persona-details"><div class="ms-Persona-primaryText">' + n + '</div><div class="ms-Persona-secondaryText">' + s + "</div></div></div></button>"; i.prepend(l), c(); }), r.on("click", ".js-selectedRemove", function () { var t = e(this).parent().find(".ms-Persona-primaryText").text(), s = i.find(".ms-Persona-primaryText:contains(" + t + ")").first(); if (s)
    if (s.parent().closest(".ms-Facepile-itemBtn").remove(), n -= 1, e(".ms-Facepile-members").children(":lt(5)").show(), n <= 5)
        e(".ms-Facepile-itemBtn--overflow").removeClass("is-active");
    else {
        var a = n - 5;
        e(".ms-Facepile-overflowText").text("+" + a);
    } }), i.on("click", ".ms-Facepile-itemBtn", function () { var t = e(this).find(".ms-Persona-primaryText").html(), i = e(this).find(".ms-Persona-secondaryText").html(), n = function () { for (var e = t.split(" "), i = "", n = 0; n < e.length; n++)
    i += e[n].charAt(0); return i.substring(0, 2); }(), s = e(this).find(".ms-Persona-initials").attr("class"), a = e(this).find(".ms-Persona-image").attr("src"), o = e(".ms-PersonaCard"), r = o.find(".ms-Persona-primaryText"), c = o.find(".ms-Persona-secondaryText"), d = o.find(".ms-Persona-initials"), m = o.find(".ms-Persona-image"); if (l.removeClass("is-active"), r.text(t), c.text(i), d.text(n), d.removeClass(), d.addClass(s), m.attr("src", a), setTimeout(function () { l.addClass("is-active"); }, 100), e(window).width() > 480) {
    var u = e(this).offset().left, h = u - 26;
    l.css({ left: h });
}
else
    l.css({ left: 0, top: "auto", position: "fixed" }); }), e(document).on("click", function (t) { var i = e(".ms-Facepile-itemBtn--member"); i.is(t.target) || 0 !== i.has(t.target).length || l.is(t.target) || 0 !== l.has(t.target).length ? l.addClass("is-active") : (l.removeClass("is-active"), l.removeAttr("style")); }); }); }; }(jQuery), function (e) { e.fn.ListItem = function () { return this.each(function () { var t = e(this); t.on("click", ".js-toggleSelection", function () { e(this).parents(".ms-ListItem").toggleClass("is-selected"); }); }); }; }(jQuery);
var fabric = fabric || {};
fabric.MessageBanner = function (e) { this.container = e, this.init(); }, fabric.MessageBanner.prototype = function () { var e, t, i, n, s, a, o, r, l, c = 700, d = 88, m = 35, u = 480, h = function () { i = o.offsetWidth, window.innerWidth >= u ? f() : p(); }, f = function () { i - t > s && s < c ? (n = "auto", a.className = "ms-MessageBanner-expand", k()) : (n = Math.min(i - t, c) + "px", a.className.indexOf("is-visible") === -1 && (a.className += " is-visible")), e.style.width = n; }, p = function () { i - (m + l.offsetWidth) > s ? (n = "auto", k()) : n = i - (m + l.offsetWidth) + "px", e.style.width = n; }, v = function (i) { o = i.container, e = i.container.querySelector(".ms-MessageBanner-clipper"), a = i.container.querySelector(".ms-MessageBanner-expand"), r = i.container.querySelector(".ms-MessageBanner-action"), t = r.offsetWidth + d, l = i.container.querySelector(".ms-MessageBanner-close"); }, g = function () { var e = a.querySelector(".ms-Icon"); o.className += " is-expanded", e.className = "ms-Icon ms-Icon--chevronsUp"; }, k = function () { var e = a.querySelector(".ms-Icon"); o.className = "ms-MessageBanner", e.className = "ms-Icon ms-Icon--chevronsDown"; }, P = function () { o.className.indexOf("is-expanded") > -1 ? k() : g(); }, y = function () { o.className.indexOf("hide") === -1 && (o.className += " hide", setTimeout(function () { o.className = "ms-MessageBanner is-hidden"; }, 500)); }, C = function () { o.className = "ms-MessageBanner"; }, b = function () { window.addEventListener("resize", h, !1), a.addEventListener("click", P, !1), l.addEventListener("click", y, !1); }, x = function () { v(this), b(), i = o.offsetWidth, s = e.offsetWidth, h(null); }; return { init: x, showBanner: C }; }(), function (e) { e.fn.NavBar = function () { return this.each(function () { var t = e(this); t.on("click", ".js-openMenu", function (e) { e.stopPropagation(), t.toggleClass("is-open"); }), t.click(function () { t.hasClass("is-open") && t.removeClass("is-open"); }), t.on("click", ".ms-NavBar-item:not(.is-disabled)", function (i) { var n = t.find(".ms-NavBar-item.ms-NavBar-item--search .ms-TextField-field"); i.stopPropagation(), 0 === e(this).children(".ms-NavBar-link").length && i.preventDefault(), e(this).siblings(".ms-NavBar-item").removeClass("is-selected"), n.length > 0 && 0 === n.val().length && e(".ms-NavBar-item.ms-NavBar-item--search").removeClass("is-open").find(".ms-TextField-field").blur(), e(this).hasClass("ms-NavBar-item--hasMenu") ? (e(this).siblings(".ms-NavBar-item--hasMenu").children(".ms-ContextualMenu:first").removeClass("is-open"), e(this).children(".ms-ContextualMenu:first").toggleClass("is-open"), e(this).toggleClass("is-selected")) : (e(this).addClass("is-selected"), t.removeClass("is-open").find(".ms-ContextualMenu").removeClass("is-open")), e(this).hasClass("ms-NavBar-item--search") && (e(this).addClass("is-open"), e(this).find(".ms-TextField-field").focus(), t.find(".ms-ContextualMenu:first").removeClass("is-open")); }), t.on("click", ".ms-NavBar-item .ms-ContextualMenu", function (i) { i.stopPropagation(), e(this).removeClass("is-open"), t.removeClass("is-open").find(".ms-NavBar-item--hasMenu").removeClass("is-selected"); }), e(document).on("click", "html", function () { var e = t.find(".ms-NavBar-item.ms-NavBar-item--search .ms-TextField-field"); t.find(".ms-NavBar-item").removeClass("is-selected").find(".ms-ContextualMenu").removeClass("is-open"), e.length > 0 && 0 === e.val().length && t.find(".ms-NavBar-item.ms-NavBar-item--search").removeClass("is-open").find(".ms-TextField-field").blur(); }); }); }; }(jQuery), function (e) { e.fn.Panel = function () { function t(e, t, n) { for (var s = 0; s < i.length; s++)
    i[s] || (t = t.toLowerCase()), e.addEventListener(i[s] + t, n, !1); } var i = ["webkit", "moz", "MS", "o", ""]; return this.each(function () { var i = e(this), n = i.find(".ms-Panel-main"); e(".ms-PanelAction-close").on("click", function () { i.addClass("ms-Panel-animateOut"); }), e(".ms-PanelAction-open").on("click", function () { i.addClass("is-open"), i.addClass("ms-Panel-animateIn"); }), t(n[0], "AnimationEnd", function (e) { e.animationName.indexOf("Out") > -1 && (i.removeClass("is-open"), i.removeClass("ms-Panel-animateIn ms-Panel-animateOut")); }), e(".panelVariant-item").on("click", function () { var t = e(this).find("span").attr("class"); switch (e(".panelVariant-item").removeClass("is-selected"), e(this).addClass("is-selected"), t) {
    case "is-default":
        e(".ms-Panel").removeClass().addClass("ms-Panel");
        break;
    case "is-left":
        e(".ms-Panel").removeClass().addClass("ms-Panel ms-Panel--left");
        break;
    case "is-lightDismiss":
        e(".ms-Panel").removeClass().addClass("ms-Panel ms-Panel--lightDismiss");
        break;
    case "is-md":
        e(".ms-Panel").removeClass().addClass("ms-Panel ms-Panel--md");
        break;
    case "is-lgFixed":
        e(".ms-Panel").removeClass().addClass("ms-Panel ms-Panel--lg ms-Panel--fixed");
        break;
    case "is-lg":
        e(".ms-Panel").removeClass().addClass("ms-Panel ms-Panel--lg");
        break;
    case "is-xl": e(".ms-Panel").removeClass().addClass("ms-Panel ms-Panel--xl");
} }); }); }; }(jQuery);
var fabric = fabric || {};
!function (e) { function t(e) { var t = e.find(".ms-PeoplePicker-searchBox"), i = t.position().left, n = t.outerWidth(), s = i + n, a = t.find(".ms-PeoplePicker-persona:last"), o = a.offset().left, r = a.outerWidth(), l = o + r, c = s - l - 7; c < 100 && (c = "100%"), e.find(".ms-PeoplePicker-searchField").outerWidth(c); } e.fn.PeoplePicker = function () { return this.each(function () { function i(t) { e("html, body").animate({ scrollTop: s.offset().top }, 367), s.hasClass("is-active") && s.removeClass("is-active"), s.hasClass("ms-PeoplePicker--Facepile") && "" === a.val() && d.children(":gt(4)").hide(), s.hasClass("ms-PeoplePicker--Facepile") && (l.addClass("ms-u-slideDownIn20"), setTimeout(function () { o.removeClass("ms-u-slideDownIn20"), l.removeClass("ms-u-slideDownIn20"); }, 1e3)), m = !0, t.stopPropagation(), s.hasClass("ms-PeoplePicker--Facepile") || o.width(s.width() - 2), s.addClass("is-active"), e(document).bind("click.peoplepicker", function () { s.removeClass("is-active"), s.hasClass("ms-PeoplePicker--Facepile") && (s.removeClass("is-searching"), e(".ms-PeoplePicker-selected").show(), e(".ms-PeoplePicker-searchMore").removeClass("is-active"), a.val("")), e(document).unbind("click.peoplepicker"), m = !1; }); } var n, s = e(this), a = s.find(".ms-PeoplePicker-searchField"), o = s.find(".ms-PeoplePicker-results"), r = s.find(".ms-PeoplePicker-selected"), l = s.find(".ms-PeoplePicker-selectedPeople"), c = s.find(".ms-PeoplePicker-selectedCount"), d = s.find(".ms-PeoplePicker-peopleList"), m = !1, u = e(".ms-PeoplePicker").find(".ms-PersonaCard"); s.on("focus", ".ms-PeoplePicker-searchField", function (e) { i(e); }), s.on("click", ".ms-PeoplePicker-searchField", function (e) { i(e); }), e(this).click(function (e) { e.stopPropagation(); }), o.on("click", ".ms-PeoplePicker-result", function () { var i = e(this), n = i.find(".ms-Persona-primaryText").html(), o = i.find(".ms-Persona-secondaryText").html(), m = function () { for (var e = n.split(" "), t = "", i = 0; i < e.length; i++)
    t += e[i].charAt(0); return t.substring(0, 2); }(), u = i.find(".ms-Persona-initials").attr("class"), h = function () { if (i.find(".ms-Persona-image").length) {
    var e = i.find(".ms-Persona-image").attr("src");
    return '<img class="ms-Persona-image" src="' + e + '" alt="Persona image">';
} return ""; }(), f = '<div class="ms-PeoplePicker-persona"><div class="ms-Persona ms-Persona--xs ms-Persona--square"><div class="ms-Persona-imageArea"><div class="' + u + '">' + m + "</div>" + h + '</div><div class="ms-Persona-presence"></div><div class="ms-Persona-details"><div class="ms-Persona-primaryText">' + n + '</div> </div></div><button class="ms-PeoplePicker-personaRemove"><i class="ms-Icon ms-Icon--x"></i> </button></div>', p = '<li class="ms-PeoplePicker-selectedPerson"><div class="ms-Persona ms-Persona--sm"><div class="ms-Persona-imageArea"><div class="' + u + '">' + m + "</div>" + h + '</div><div class="ms-Persona-presence"></div><div class="ms-Persona-details"><div class="ms-Persona-primaryText">' + n + '</div><div class="ms-Persona-secondaryText">' + o + '</div></div></div><button class="ms-PeoplePicker-resultAction js-selectedRemove"><i class="ms-Icon ms-Icon--x"></i></button></li>'; if (s.hasClass("ms-PeoplePicker--Facepile") || s.hasClass("ms-PeoplePicker--membersList")) {
    r.hasClass("is-active") || r.addClass("is-active"), l.prepend(p), s.removeClass("is-active");
    var v = s.find(".ms-PeoplePicker-selectedPerson").length;
    c.html(v), d.children().show(), d.children(":gt(4)").hide(), e(".ms-PeoplePicker-searchMore").removeClass("is-active"), a.val("");
}
else
    a.before(f), s.removeClass("is-active"), t(s); }), s.on("click", ".ms-PeoplePicker-personaRemove", function () { e(this).parents(".ms-PeoplePicker-persona").remove(), 0 === e(".ms-PeoplePicker-persona").length ? s.find(".ms-PeoplePicker-searchField").outerWidth("100%") : t(s); }), o.on("click", ".js-searchMore", function () { var t = e(this), i = t.find(".ms-PeoplePicker-searchMorePrimary"), o = i.html(), r = a.val(); t.addClass("is-searching"), i.html("Searching for " + r), n ? n.start() : n = new fabric.Spinner(t.get(0)), s.hasClass("ms-PeoplePicker--Facepile") && setTimeout(function () { d.children().show(); }, 1500), setTimeout(function () { t.removeClass("is-searching"), i.html(o), n.stop(); }, 1500); }), o.on("click", ".js-resultRemove", function (t) { t.stopPropagation(), e(this).parent(".ms-PeoplePicker-result").remove(); }), o.on("click", ".js-resultExpand", function (t) { t.stopPropagation(), e(this).parent(".ms-PeoplePicker-result").toggleClass("is-expanded"); }), l.on("click", ".js-selectedRemove", function (t) { t.stopPropagation(), e(this).parent(".ms-PeoplePicker-selectedPerson").remove(); var i = s.find(".ms-PeoplePicker-selectedPerson").length; c.html(i), 0 === s.find(".ms-PeoplePicker-selectedPerson").length && r.removeClass("is-active"); }); var h = function (t, i, n) { return t.find(".ms-Persona-primaryText").filter(function () { return n ? e(this).text().toLowerCase() === i : e(this).text().toLowerCase() !== i; }).parents(".ms-PeoplePicker-peopleListItem"); }; s.on("keyup", ".ms-PeoplePicker-searchField", function (t) { var i = [], n = [], a = o.find(".ms-Persona-primaryText"); s.addClass("is-searching"), r.hide(), d.children(":lt(5)").show(), e(".ms-PeoplePicker-searchMore").addClass("is-active"), a.each(function () { i.push(e(this).text()); }); for (var c = 0; c < i.length; c++) {
    var m, u = i[c].toLowerCase(), f = t.target.value.toLowerCase();
    u.indexOf(f) > -1 ? (m = i[c].toLowerCase(), n.push(i[c]), h(o, m, !0).show()) : h(o, m, !1).hide();
} "" === e(this).val() && (s.removeClass("is-searching"), r.show(), e(".ms-PeoplePicker-searchMore").removeClass("is-active"), l.addClass("ms-u-slideDownIn20"), setTimeout(function () { l.removeClass("ms-u-slideDownIn20"); }, 1e3), d.children(":gt(4)").hide()); }), l.on("click", ".ms-Persona", function () { var t = e(this).find(".ms-Persona-primaryText").html(), i = e(this).find(".ms-Persona-secondaryText").html(), n = function () { for (var e = t.split(" "), i = "", n = 0; n < e.length; n++)
    i += e[n].charAt(0); return i.substring(0, 2); }(), s = e(this).find(".ms-Persona-initials").attr("class"), a = e(this).find(".ms-Persona-image").attr("src"), o = e(".ms-PersonaCard"), r = o.find(".ms-Persona-primaryText"), l = o.find(".ms-Persona-secondaryText"), c = o.find(".ms-Persona-initials"), d = o.find(".ms-Persona-image"); if (u.removeClass("is-active"), r.text(t), l.text(i), c.text(n), c.removeClass(), c.addClass(s), d.attr("src", a), setTimeout(function () { u.addClass("is-active"), setTimeout(function () { u.css({ "animation-name": "none" }); }, 300); }, 100), e(window).width() > 480) {
    var m = e(this).offset().top, h = m + 10;
    u.css({ top: h, left: 0 });
}
else
    u.css({ top: "auto" }); }), e(document).on("click", function (t) { var i = e(".ms-PeoplePicker-selectedPerson").find(".ms-Persona"); i.is(t.target) || u.is(t.target) || 0 !== u.has(t.target).length ? u.addClass("is-active") : (u.removeClass("is-active"), setTimeout(function () { u.removeAttr("style"); }, 300)); }); }); }; }(jQuery), function (e) { e.fn.PersonaCard = function () { return this.each(function () { var t = e(this); t.on("click", ".ms-PersonaCard-action", function () { t.find(".ms-PersonaCard-action").removeClass("is-active"), e(this).addClass("is-active"); var i = function (e, t) { var i = e.className + "", n = t.charAt(0).toUpperCase() + t.slice(1), s = "ms-PersonaCard-detail" + n; i !== s && (e.classList.remove(i), e.classList.add(s)); }, n = e(this).attr("id"); i(e(this).parent().next().find("#detailList")[0], n); var s = e(this).attr("id"); t.find(".ms-PersonaCard-actionDetails").removeClass("is-active"), t.find("#" + s + ".ms-PersonaCard-actionDetails").addClass("is-active"); }), t.on("click", ".ms-PersonaCard-detailExpander", function () { e(this).parent(".ms-PersonaCard-actionDetails").toggleClass("is-collapsed"); }); }); }; }(jQuery), function (e) { e.fn.Pivot = function () { return this.each(function () { var t = e(this); t.on("click", ".ms-Pivot-link", function (t) { t.preventDefault(); var i = e(this).find(".ms-Pivot-ellipsis"); 0 === i.length && (e(this).siblings(".ms-Pivot-link").removeClass("is-selected"), e(this).addClass("is-selected")); }); }); }; }(jQuery);
var fabric = fabric || {};
fabric.ProgressIndicator = function (e) { this.container = e, this.cacheDOM(); }, fabric.ProgressIndicator.prototype = function () { var e, t, i, n, s, a, o = function (e) { a.style.width = Math.round(t * e) + "px"; }, r = function (t) { e = t; var i = e / n; this.setProgressPercent(i); }, l = function (e) { n = e; }, c = function (e) { i.innerHTML = e; }, d = function (e) { s.innerHTML = e; }, m = function () { i = this.container.querySelector(".ms-ProgressIndicator-itemName") || null, s = this.container.querySelector(".ms-ProgressIndicator-itemDescription") || null, a = this.container.querySelector(".ms-ProgressIndicator-progressBar"), t = this.container.querySelector(".ms-ProgressIndicator-itemProgress").offsetWidth; }; return { setProgressPercent: o, setName: c, setDescription: d, setProgress: r, setTotal: l, cacheDOM: m }; }(), function (e) { e.fn.SearchBox = function () { return this.each(function () { var t = !1, i = e(this).find(".ms-SearchBox-field"); i.on("focus", function () { e(this).siblings(".ms-SearchBox-label").hide(), e(this).parent(".ms-SearchBox").addClass("is-active"); }), i.on("mouseover", function () { i.addClass("hovering"); }), i.on("mouseout", function () { i.removeClass("hovering"); }), e(this).find(".ms-SearchBox-closeButton").on("mousedown", function () { t = !0; }), e(this).find(".ms-SearchBox-field").on("blur", function () { t && (e(this).val(""), i.addClass("hovering")); var n = e(this).parent(".ms-SearchBox"); setTimeout(function () { n.removeClass("is-active"); }, 10), 0 === e(this).val().length && e(this).siblings(".ms-SearchBox-label").show(), t = !1; }); }); }; }(jQuery);
var fabric = fabric || {};
fabric.Spinner = function (e) { function t() { i(), u = setInterval(function () { for (var e = k.length; e--;)
    a(k[e]); }, P); } function i() { clearInterval(u); } function n() { m(), d(), c(), s(), t(); } function s() { var e, t = 0, i = 1; for (y = 1 / f, t; t < f; t++) {
    var n = k[t];
    e = y * i++, r(n.element, e);
} } function a(e) { var t = o(e.element) - y; t <= 0 && (t = 1), r(e.element, t); } function o(e) { return parseFloat(window.getComputedStyle(e).getPropertyValue("opacity")); } function r(e, t) { e.style.opacity = t; } function l() { var e = document.createElement("div"); return e.className = "ms-Spinner-circle", e.style.width = e.style.height = C * p + "px", e; } function c() { for (var e, t = 0, i = C * p, n = 2 * Math.PI / f, s = f, a = .5 * (C - i); s--;) {
    var o = l(), r = Math.round(.5 * C + a * Math.cos(t) - .5 * o.clientWidth) - .5 * i, c = Math.round(.5 * C + a * Math.sin(t) - .5 * o.clientHeight) - .5 * i;
    h.appendChild(o), o.style.left = r + "px", o.style.top = c + "px", t += n, e = { element: o, j: s }, k.push(e);
} } function d() { h.className.indexOf("large") > -1 && (C = 28, g = .179), p = g, f = 8; } function m() { v.className.indexOf("ms-Spinner") === -1 ? (h = document.createElement("div"), h.className = "ms-Spinner", v.appendChild(h)) : h = v; } var u, h, f, p, v = e, g = .2, k = [], P = 90, y = 0, C = 20; return n(), { start: t, stop: i }; }, function (e) { e.fn.TextField = function () { return this.each(function () { e(this).hasClass("ms-TextField--placeholder") && (e(this).on("click", function () { e(this).find(".ms-Label").hide(); }), e(this).find(".ms-TextField-field").on("focus", function () { e(this).siblings(".ms-Label").hide(); }), e(this).find(".ms-TextField-field").on("blur", function () { 0 === e(this).val().length && e(this).siblings(".ms-Label").show(); })), e(this).hasClass("ms-TextField--underlined") && (e(this).find(".ms-TextField-field").on("focus", function () { e(this).parent(".ms-TextField--underlined").addClass("is-active"); }), e(this).find(".ms-TextField-field").on("blur", function () { e(this).parent(".ms-TextField--underlined").removeClass("is-active"); })); }); }; }(jQuery);
//# sourceMappingURL=jquery.fabric.min.js.map